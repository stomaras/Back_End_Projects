...
log1.warning("Warning of a impeding danger")
log1.error("This is an error")
log1.critical("This is a critical Mistake")

log2 = Logger.get_instance('file2.txt')
log2.info("...This is an information")
log2.warning("...Warning of a impeding danger")
log2.error("...This is an error")
log2.critical("...This is a critical Mistake")