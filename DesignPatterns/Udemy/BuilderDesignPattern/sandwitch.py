...
class ClubSandwitchBuilder(SandwichBuilder):
    def add_bread(self):
...
class VeggieSandwichBuilder(SandwichBuilder):
    def add_bread(self):
        self.sandwich._bread = "Whole Bread"
...
if __name__ == "__main__":
    waiter = Waiter()
    waiter.get_builder(ClubSandwitchBuilder())
    waiter.create_sandwich()
    print("=====Club SANDWICH======")
    sand = waiter.serve_sandwich()
    print(sand)
    
    waiter.get_builder(VeggieSandwichBuilder())
    waiter.create_sandwich()
    print("========Veggie Sandwich=========")
    sand2 = waiter.serve_sandwich()
    print(sand2)
